...
NProduction = {
	...
	BASE_FACTORY_SPEED_NAV = 4.50, 				-- Base factory speed multiplier (how much hoi3 style IC each factory gives).
...
NAir = {
	...
	AIR_MORE_GROUND_CREWS_COST = 1.0,					-- CP cost to maintain more ground crews -- MSB CHANGE NOT VANILLA
