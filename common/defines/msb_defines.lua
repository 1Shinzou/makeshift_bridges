...
NDefines.NMilitary.UNIT_EXP_LEVELS = { 0.02,	0.04,	0.06,	0.08,	0.1,	0.14,	0.18,	0.22,	0.26,	0.3,	0.39,	0.48,	0.57,	0.66,	0.75, }		-- Experience needed to progress to the next level
...
-- Air Rework
NDefines.NMilitary.LAND_AIR_COMBAT_MAX_PLANES_PER_ENEMY_WIDTH = 1.5   --vanilla 3
...
NDefines.NAir.AIR_WING_BOMB_DAMAGE_FACTOR = 0.45 --Chrom Bombing Fix; HMM = 0.6
...
NDefines.NAir.PORT_STRIKE_DAMAGE_FACTOR = 0.25	-- How much damage is dealt to ports during a port strike (per plane damage [complex number] * num flying planes * define)
NDefines.NAir.NAVAL_STRIKE_BASE_STR_TO_PLANES_RATIO = 0.01		-- Max airbombers to do port strike comparing to strength
